import { formaterEnDateFrancaise } from './date'
import { libelleSource } from './libelleSource'
import { EvenementHistorique, SourcePivot } from '@/use-cases/queries/shared/HistoriqueEvenement'

export function presenterEvenements(evenements: ReadonlyArray<EvenementHistorique>): ReadonlyArray<EvenementViewModel> {
...
export function presenterSourcesPivots(sourcesPivots: ReadonlyArray<SourcePivot>): ReadonlyArray<SourcePivotViewModel> {
  return sourcesPivots.map((sp) => ({
