          ...
          <div className="fr-header__body-row fr-px-5w">
            <div className="fr-header__brand">
                ...
                <div className="fr-header__logo">
                  <svg aria-hidden="true" height="40" viewBox="0 0 42 40" width="42" xmlns="http://www.w3.org/2000/svg">
                    <path
                      ...
                      fill="url(#paint0_linear_forbidden)"
                    />
                    <path
              ...
              <div className="fr-header__service">
                <p className="fr-header__service-title">Mon Inclusion Numérique</p>
              </div>
            </div>
            <div className="fr-header__tools">
              <div className="fr-header__tools-links">
                <ul aria-label="menu" className="fr-links-group">
                  <li>
      ...
      <main className="fr-container--fluid" id="content">
        <div className="fr-container fr-pt-8w fr-pb-10w center">
          ...
          <p className="color-grey fr-text--lg fr-mb-2w">
            Votre compte ne dispose pas des droits nécessaires pour la consulter. Vérifiez que vous êtes connecté avec
            le bon compte, ou demandez un accès à notre équipe.
          </p>
