...
export const metadata: Metadata = {
  description:
    "Découvrez les outils numériques pour piloter l'inclusion numérique : Mon Inclusion Numérique, cartographie nationale, données territoriales et outils de pilotage.",
  keywords: [
    'outils numériques',
