...
export const metadata: Metadata = {
  description:
    "Découvrez les dispositifs, lieux et outils pour favoriser l'inclusion numérique sur les territoires. Accompagner tous les publics vers une utilisation autonome, sécurisée et confiante du numérique.",
  keywords: [
    'inclusion numérique',
    'ANCT',
    ...
    <>
      ...
      <section className="fr-py-12w">
        <div className="fr-container">
          ...
          <div className="fr-grid-row fr-mb-0w" style={{ alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            <div className={`fr-col-12 fr-col-md-5 ${styles.contentRight}`}>
              <h3 className="fr-h4 fr-mb-0">Des inégalités numériques persistantes dans notre société</h3>
              ...
              <p className="fr-text--md fr-mb-0">
                ...
                <strong>inégalités numériques</strong> persistent dans notre société.
              </p>
              <p className="fr-text--md fr-mb-0">
                ...
                Principalement, parce que ces personnes ne se sentent pas assez compétentes pour utiliser pleinement le
                numérique.
              </p>
              <p className="fr-text--sm fr-mb-0" style={{ color: '#666' }}>
                * Baromètre du numérique, 2024.
                <br />
                ** ANCT, CREDOC, Université Rennes 2 CREAD-M@rsouin, La société numérique française : définir et mesurer
                l&apos;éloignement numérique, 2023.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="fr-container">
          ...
          <div className="fr-grid-row fr-mb-0w" style={{ alignItems: 'center', justifyContent: 'space-between' }}>
            <div className={`fr-col-12 fr-col-md-5 ${styles.contentLeft}`}>
              <h2 className="fr-h2 fr-mb-0">Une approche renouvelée de l&apos;inclusion numérique</h2>
              <p className="fr-text--md fr-mb-0">
                Concrètement, tous les individus ne sont pas en situation de tirer les mêmes profits des technologies
                numériques dans leur vie quotidienne. Loin d&apos;être une simple question d&apos;âge, cette capacité
                est fortement influencée par{' '}
                <strong style={{ color: '#000091' }}>les conditions d&apos;existence des individus,</strong> en
                particulier leur niveau d&apos;étude.
              </p>
              <p className="fr-text--md">
                A ce titre, plus de <strong style={{ color: '#000091' }}>60 % des Français non-diplômés*</strong>{' '}
      ...
      <section className="fr-py-4w">
        <div className="fr-container">
          ...
          <div className="fr-grid-row" style={{ alignItems: 'center', justifyContent: 'space-between' }}>
            <div className="fr-col-12 fr-col-md-5" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <p className="fr-text--md  fr-mb-0">Ici réside désormais l&apos;enjeu de l&apos;inclusion numérique :</p>
              <h2 className="fr-h2 fr-mb-0">
                Permettre à toutes, tous, sans distinction, d&apos;utiliser le numérique pour accroître son bien-être et
                favoriser son pouvoir d&apos;agir dans la société.
              </h2>
            </div>
            <div className="fr-col-12 fr-col-md-6" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <div>
                <img
              ...
              <p className="fr-text--md fr-mb-0">
                Plus globalement, l&apos;éloignement numérique ne peut plus être considéré comme un simple enjeu
                technique ou technologique : il s&apos;agit d&apos;abord d&apos;un phénomène social.
              </p>
              <p className="fr-text--md">
      ...
      <section className="fr-py-4w">
        <div className="fr-container">
          ...
          <div className="fr-grid-row fr-mb-6w" style={{ alignItems: 'center', justifyContent: 'space-between' }}>
            <div className={`fr-col-12 fr-col-md-5 ${styles.contentLeft}`}>
              ...
              <h3 className="fr-h4 fr-mb-0" style={{ fontWeight: 700 }}>
              ...
              <p className="fr-text--md fr-mb-0">
                ...
                médiathèques, centres sociaux, tiers-lieux, espaces France Services ou associations locales. Ces
                structures proposent des ateliers, des permanences et un accueil de proximité pour répondre aux besoins
                de chacun.
              </p>
              <div>
                <Link className="fr-btn" href="/vitrine/lieux">
          ...
          <div className="fr-grid-row" style={{ alignItems: 'center', justifyContent: 'space-between' }}>
            <div className={`fr-col-12 fr-col-md-5 ${styles.contentRight}`}>
              ...
              <p className="fr-text--md  fr-mb-0">
                Plusieurs dispositifs existent pour accompagner la population : médiateurs numériques, ateliers de
                montée en compétences, actions d&apos;aller-vers ou encore programmes locaux portés par les
                collectivités. Ils permettent d&apos;accompagner tous les publics vers une utilisation plus autonome,
                sécurisée et confiante du numérique.
              </p>
              <div style={{ marginBottom: '2em' }}>
                <Link className="fr-btn" href="/vitrine/dispositifs">
          ...
          <div className="fr-grid-row fr-mb-6w" style={{ alignItems: 'center', justifyContent: 'space-between' }}>
            <div className={`fr-col-12 fr-col-md-5 ${styles.contentLeft}`}>
              ...
              <p className="fr-text--md  fr-mb-0">
                Accédez aux données qui éclairent les dynamiques locales : actions mises en œuvre dans les feuilles de
                route territoriales, types d&apos;accompagnements proposés, profils et besoins des publics
                bénéficiaires. Ces analyses permettent de suivre et de mesurer les besoins de la population et
                d&apos;ajuster les stratégies locales d&apos;inclusion numérique.
              </p>
              <div>
                <Link className="fr-btn" href="/vitrine/donnees-territoriales">
          ...
          <div className="fr-grid-row" style={{ alignItems: 'center', justifyContent: 'space-between' }}>
            <div className={`fr-col-12 fr-col-md-5 ${styles.contentRight}`}>
              ...
              <h3 className="fr-h4" style={{ fontWeight: 700 }}>
                Les outils pour les professionnels de l&apos;inclusion numérique
              </h3>
              <p className="fr-text--md  fr-mb-0">
                Plusieurs outils permettent aux acteurs de l&apos;inclusion numérique de travailler efficacement. Parmi
                eux, Mon Inclusion Numérique constitue la suite d&apos;outil des porteurs de dispositifs
                d&apos;inclusion numérique. La Coop de la médiation est l&apos;outil métier des médiateurs numériques
                oeuvrant partout en France.
              </p>
              <div>
                <Link className="fr-btn" href="/vitrine/outils-numeriques">
          ...
          <div className="fr-grid-row" style={{ alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            <div className={`fr-col-12 fr-col-md-5 ${styles.contentRight}`}>
              ...
              <p className="fr-text--md">
                ...
                votre département. Vous pourrez ainsi porter ou contribuer à des actions pensées et mises en oeuvre de
                façon collégiale.
              </p>
              <div>
