...
import { PrismaStructuresLoader } from '@/gateways/PrismaStructureLoader'
...
export async function GET(request: NextRequest): Promise<NextResponse<StructuresReadModel | null>> {
  ...
  const rechercherLesStructures = new RechercherLesStructures(new PrismaStructuresLoader(prisma))
