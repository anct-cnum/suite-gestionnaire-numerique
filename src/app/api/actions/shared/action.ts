...
export const ActionValidator = z
  ...
  .refine(
    (data) => {
      if (data.anneeDeFin === undefined || data.anneeDeFin === '' || data.anneeDeFin === null) {
        return true
      }
  ...
  .refine(
    (data) => {
      if (data.demandeDeSubvention === undefined || data.demandeDeSubvention === null) {
        return true
      }
