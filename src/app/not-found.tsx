    ...
    <div className="fr-container">
      <div className="fr-my-7w fr-mt-md-12w fr-mb-md-10w fr-grid-row fr-grid-row--gutters fr-grid-row--middle fr-grid-row--center">
        ...
        <div className="fr-col-12 fr-col-md-3 fr-col-offset-md-1 fr-px-6w fr-px-md-0 fr-py-0">
          ...
          >
            <use className="fr-artwork-motif" href="pictos/ovoid.svg#artwork-motif" />
            <use className="fr-artwork-background" href="pictos/ovoid.svg#artwork-background" />
            <g transform="translate(40, 60)">
              <use
                className="fr-artwork-decorative"
                href="pictos/technical-error.svg#artwork-decorative"
              />
              <use className="fr-artwork-minor" href="pictos/technical-error.svg#artwork-minor" />
              <use className="fr-artwork-major" href="pictos/technical-error.svg#artwork-major" />
            </g>
          </svg>
        </div>
      </div>
