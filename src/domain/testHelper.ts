...
export function membreInvalideFactory(override?: Partial<Parameters<typeof membreFactory>[0]>): Membre {
  return membreFactory({
    nom: 'La Poste',
    statut: 'candidat',
    uid: {
      value: 'membreInvalideFooId',
    },
    uidGouvernance: {
      value: 'gouvernanceFooId',
    },
...
export function membreValideFactory(override?: Partial<Parameters<typeof membreFactory>[0]>): Membre {
  return membreFactory({
    nom: 'La Poste',
    roles: ['observateur'],
    statut: 'valide',
