...
export default function LieuInclusionDetailsServicesHeader(): ReactElement {
  return (
    <div className="fr-p-4w">
      ...
      <h2 className="fr-h4 fr-mb-1w fr-text-label--blue-france">Services d&apos;inclusion numérique</h2>
      <p className="fr-text--sm fr-mb-0 fr-text-mention--grey">
        Renseignez des informations sur les services d&apos;inclusion numérique proposés dans ce lieu afin
