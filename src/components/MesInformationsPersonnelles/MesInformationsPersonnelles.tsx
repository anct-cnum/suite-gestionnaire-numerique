  ...
  return (
    <div className="fr-grid-row fr-grid-row--center">
      <div>
        ...
        <p className="fr-text--sm color-grey">Retrouvez ici, les informations de votre compte.</p>
        <section aria-labelledby="mesInformationsPersonnelles" className="grey-border fr-p-4w fr-mb-4w">
          <div className="fr-grid-row space-between fr-grid-row--middle">
            <h2 className="fr-h6" id="mesInformationsPersonnelles">
          ...
          <div className="fr-grid-row fr-grid-row--center fr-grid-row--gutters">
            <InformationPersonnelle label="Nom" value={mesInformationsPersonnellesViewModel.nom} />
            <InformationPersonnelle label="Prénom" value={mesInformationsPersonnellesViewModel.prenom} />
        ...
        {mesInformationsPersonnellesViewModel.structure ? (
          <section aria-labelledby="maStructure" className="grey-border fr-p-4w fr-mb-4w">
            <h2 className="fr-h6" id="maStructure">
              Ma structure
            </h2>
            <hr />
            <div className="fr-grid-row fr-grid-row--center fr-grid-row--gutters">
              ...
              <InformationPersonnelle
                label={
                  <>
                    Numéro de <abbr title="Système d’Identification du Répertoire des ÉTablissements">SIRET</abbr>
                    {/**/}/{/**/}
                    <abbr title="Répertoire d’Identification des Entreprises et des ÉTablissements">RIDET</abbr>
                  </>
                }
                value={mesInformationsPersonnellesViewModel.structure.numeroDeSiret}
              />
              <InformationPersonnelle label="Adresse" value={mesInformationsPersonnellesViewModel.structure.adresse} />
            </div>
            <hr className="fr-mt-3w" />
            <h3 className="fr-text--md">Contact principal de la structure</h3>
            <div className="fr-grid-row fr-grid-row--center fr-grid-row--gutters">
              <InformationPersonnelle label="Nom" value={mesInformationsPersonnellesViewModel.structure.contact.nom} />
              <InformationPersonnelle
                label="Prénom"
        ...
        <section aria-labelledby="monRole" className="grey-border fr-p-4w fr-mb-4w">
          <h2 className="fr-h6" id="monRole">
            Mon rôle
          </h2>
          <p className="fr-text--sm color-grey">
            Le rôle qui vous est attribué donne accès à des fonctionnalités et des droits spécifiques.{' '}
            <ExternalLink href="https://aide.conseiller-numerique.gouv.fr/fr/" title="Aide">
              Contacter le support
            </ExternalLink>{' '}
            pour le modifier.
          </p>
          <Badge color="info">{mesInformationsPersonnellesViewModel.role}</Badge>
        </section>
        <section aria-labelledby="supprimerMonCompte" className="grey-border fr-p-4w fr-mb-4w">
          <h2 className="fr-h6" id="supprimerMonCompte">
