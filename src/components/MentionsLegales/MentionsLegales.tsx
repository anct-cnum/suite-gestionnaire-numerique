    ...
    <div className="fr-grid-row fr-grid-row--center">
      ...
      >
        ...
        <section aria-labelledby="editeur-title" className="fr-mb-4w">
          <h2 className="fr-h6" id="editeur-title">
            Éditeur de la plateforme
          </h2>
          <p>
            <strong>Mon inclusion numérique</strong> est édité au sein de l&apos;Agence nationale de la cohésion des
        ...
        <section aria-labelledby="directeur-title" className="fr-mb-4w">
          <h2 className="fr-h6" id="directeur-title">
            Directeur de la publication
          </h2>
          <p>
            Le directeur de publication est Monsieur <strong>Henri PREVOST</strong> , Directeur général de l&apos;ANCT.
          </p>
        </section>

        <section aria-labelledby="hebergeur-title" className="fr-mb-4w">
          <h2 className="fr-h6" id="hebergeur-title">
        ...
        <section aria-labelledby="accessibilite-title" className="fr-mb-4w">
          <h3 className="fr-text--md fr-mt-3w">Signaler un dysfonctionnement</h3>
          <p>
