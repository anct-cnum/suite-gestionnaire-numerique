    ...
    >
      ...
      <article aria-label="Résumé des financements">
        {data.enveloppes.length === 0 ? (
          <TableauVide>
            <span className="fr-text--bold">👻 Aucun crédit engagé par l&apos;état</span>
            {' pour cette structure'}
          </TableauVide>
        ) : (
          <div className="grey-border border-radius fr-p-4w" style={{ display: 'flex', gap: '3.5rem', width: '100%' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
        ...
        {data.conventions.length === 0 ? (
          <TableauVide>
            <span className="fr-text--bold">👻 Aucune convention trouvée</span>
            {' pour cette structure'}
          </TableauVide>
        ) : (
          <Table
