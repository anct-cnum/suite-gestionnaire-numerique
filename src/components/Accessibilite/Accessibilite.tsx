  ...
  return (
    <div className="fr-grid-row fr-grid-row--center">
      ...
      >
        ...
        <p>
          Établie le <span>18 juin 2025.</span>
        </p>

        <p>
          <span>ANCT - Agence Nationale de la Cohésion des Territoires</span> s&apos;engage à rendre son service
        ...
        <p className="fr-text--sm">
          Cette déclaration d&apos;accessibilité a été créé le <span>18 juin 2025</span> grâce au{' '}
          <ExternalLink
