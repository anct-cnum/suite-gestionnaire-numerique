...
export default function Accessibilite(): ReactElement {
  return (
    <>
      ...
      <h2>À propos</h2>
      <p>
        Le handicap est défini comme : toute limitation d’activité ou restriction de participation à
      ...
      <ul>
        <li>
          ...
          l’utilisateur ; proposer des équivalents textuels à tout contenu non textuel ; créer un
          contenu qui puisse être présenté de différentes manières sans perte d’information ni de
          structure (par exemple avec une mise en page simplifiée) ;
        </li>
        <li>
          utilisables : par exemple, fournir à l’utilisateur des éléments d’orientation pour
          naviguer, trouver le contenu ; rendre toutes les fonctionnalités accessibles au clavier ;
          laisser à l’utilisateur suffisamment de temps pour lire et utiliser le contenu ; ne pas
          concevoir de contenu susceptible de provoquer des crises d’épilepsie ;
        </li>
        <li>
      ...
      <p>
        L’équipe de Conseiller Numérique s’engage et travaille à améliorer le niveau d’accessibilité
        du site et sa conformité avec les normes en la matière :
      </p>
      <ul>
        <li>
      ...
      <p>
        Notre équipe a ainsi travaillé sur les contrastes de couleur, la présentation et la
        structure de l’information ou encore la clarté des formulaires.
        <br />
        D’autres améliorations vont être apportées.
      </p>
      <h2>Améliorations et contact</h2>
      <p>
        L’équipe de Conseiller Numérique reste à votre écoute et entière disposition, si vous
        souhaitez nous signaler un défaut de conception. Vous pouvez nous aider à améliorer
        l’accessibilité du site en nous signalant les problèmes éventuels que vous rencontrez :{' '}
        <LienExterne href="https://aide.conseiller-numerique.gouv.fr/fr/" title="Contactez-nous">
          Contactez-nous
        </LienExterne>
        {''}.
      </p>
