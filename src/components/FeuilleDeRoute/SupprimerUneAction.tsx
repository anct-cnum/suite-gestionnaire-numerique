...
export default function SupprimerUneAction({ actionASupprimer, closeModal, id, isOpen }: Props): ReactElement {
    ...
    <Modal close={closeModal} id={id} isOpen={isOpen} labelId={labelModaleId}>
      <div className="fr-modal__content">
        <ModalTitle id={labelModaleId}>
          Vous allez supprimer l’action {actionASupprimer.nom} de la feuille de route ?
        </ModalTitle>
        <p>En cliquant sur confirmer, l’action sera définitivement supprimée de votre feuille de route</p>
      </div>
      <div className="fr-modal__footer">
        <div className="fr-btns-group fr-btns-group--right fr-btns-group--inline-lg fr-btns-group--icon-left">
          ...
          <button
            ...
            disabled={isDisabled}
            onClick={() => {
              void supprimer(actionASupprimer.uid)
            }}
            type="button"
          >
