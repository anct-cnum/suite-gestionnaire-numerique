...
describe('membres gouvernance', () => {
  ...
  describe('quand j’ouvre le formulaire pour ajouter un membre', () => {
    ...
    it('puis que je sélectionne un membre alors ses informations s’affichent', () => {
      // GIVEN
      afficherMembres()
    ...
    it('que je sélectionne un membre puis que je le désélectionne alors les informations de base s’affichent', () => {
      ...
      jOuvreLeFormulairePourAjouterUnMembre()
      const ajouterUnMembreDrawer = screen.getByRole('dialog', { name: 'Ajouter un membre à la gouvernance' })
      jeSelectionneUnCandidat('99229991601034')
    ...
    it('puis que je sélectionne un membre et je le valide, alors le drawer se ferme, le formulaire est réinitialisé, une notification s’affiche et les membres sont mises à jour', async () => {
      // GIVEN
      ...
      expect(accepterUnMembreAction).toHaveBeenCalledWith({
        ...
        uidMembreInvalide: 'structure-99229991601034',
      })
