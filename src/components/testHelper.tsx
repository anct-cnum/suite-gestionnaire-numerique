...
export function renderComponent(
  ...
  const clientContextProviderDefaultValue = {
    ...
    creerUnLieuInclusionAction: vi.fn(),
    deciderAppariementLieuAction: vi.fn(),
    ...
    modifierLieuInclusionInformationsGeneralesAction: vi.fn(),
    ...
    rechercherAdressesAction: vi.fn(),
    rechercherLieuxInclusionSimilairesAction: vi.fn(),
