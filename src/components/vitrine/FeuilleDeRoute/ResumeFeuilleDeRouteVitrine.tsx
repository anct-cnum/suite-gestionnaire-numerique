...
export default function ResumeFeuilleDeRouteVitrine({ children, feuilleDeRoute }: Props): ReactElement {
  return (
    <div aria-label={feuilleDeRoute.nom} className={localStyles.card} role="region">
      ...
      <div className="fr-mb-3w">
        ...
        {feuilleDeRoute.porteur === undefined ? (
          ...
          <div className="fr-tag">{feuilleDeRoute.porteur.label}</div>
        )}{' '}
        ...
        <div className="container">
          <div className="fr-grid-row fr-grid-row--gutters">
            <div className="fr-col-12 fr-col-md-4">
              <p className="fr-text--bold fr-mb-1w fr-mb-md-0">Budget total de la feuille de route</p>
            </div>
            <div className="fr-col-12 fr-col-md-8">
              <p className={`fr-text--bold fr-mb-1w ${localStyles.budgetValue}`}>{feuilleDeRoute.totaux.budget}</p>
              <p className={`fr-mb-0 ${localStyles.budgetValue}`}>{feuilleDeRoute.wordingDetailDuBudget}</p>
            </div>
          </div>
        </div>
      </div>
