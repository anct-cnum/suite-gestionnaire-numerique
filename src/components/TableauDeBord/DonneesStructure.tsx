        ...
        <div className="background-blue-france fr-p-3w border-radius fr-mb-2w">
          <div className="fr-grid-row fr-grid-row--middle fr-mb-1w">
            <div className="background-white fr-p-1-5v border-radius fr-mr-2w">
              <span
                aria-hidden="true"
                className="fr-icon-map-pin-2-line color-blue-france"
              />
            </div>
        ...
        <div className="background-blue-france fr-p-3w border-radius">
          <div className="fr-grid-row fr-grid-row--middle fr-mb-1w">
            <div className="background-white fr-p-1-5v border-radius fr-mr-2w">
              <span
                aria-hidden="true"
                className="fr-icon-team-line color-blue-france"
              />
            </div>
            <div className="fr-h2 fr-m-0">
              {viewModel.nombreMediateurs}
            </div>
          </div>
          <div className="font-weight-500">
        ...
        >
          <div className="fr-grid-row fr-grid-row--middle fr-mb-1w">
            <TitleIcon
              ...
              icon="service-line"
            />
            <div className="fr-h2 fr-m-0 fr-ml-2w">
          ...
          {viewModel.accompagnements.repartition.length > 0 ? (
            <div className="fr-mt-3w">
              <Bar
                backgroundColor={viewModel.accompagnements.repartition.map(
                  (_, index) => index === viewModel.accompagnements.repartition.length - 1
                    ? '#000091'
                    : '#CACAFB'
                )}
...
export type DonneesStructureViewModel = Readonly<{
  accompagnements: Readonly<{
    repartition: ReadonlyArray<Readonly<{
      mois: string
      nombre: number
    }>>
    total: string
