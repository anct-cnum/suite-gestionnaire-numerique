      ...
      <header className="fr-header">
          ...
          <div className={`fr-header__body-row fr-px-5w ${styles['fr-header__body-row']}`}>
              ...
              <div className="fr-header__service">
                <Link href="/tableau-de-bord" title="Accueil">
                  <p className="fr-header__service-title">
                    <span className={styles['libelle-session-utilisateur__prefix']}>MIN</span>
                    <span className={`${styles['libelle-session-utilisateur__prefix']} color-grey`}>&nbsp;/&nbsp;</span>
            ...
            <div className="fr-header__tools">
              <div className="fr-header__tools-links">
                <ul aria-label="menu" className={`fr-links-group ${styles['fr-links-group']}`} id="menuUtilisateur">
                  <li>
        ...
        <dialog aria-labelledby="button-500" className="fr-header__menu fr-modal" id="modal-499">
          <div className="fr-container">
            <button aria-controls="modal-499" className="fr-btn--close fr-btn" type="button">
              Fermer
            </button>
