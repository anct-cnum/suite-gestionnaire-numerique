...
describe('en-tête : en tant qu’utilisateur authentifié', () => {
  it('quand j’affiche l’en-tête alors j’affiche les liens du menu', () => {
    ...
    expect(monCompte).toHaveAttribute('aria-controls', 'drawerId')
  ...
  it('quand je clique sur le bouton affichant mes nom et prénom alors le menu utilisateur s’ouvre', () => {
    ...
    expect(mesInformations).toHaveAttribute('aria-controls', 'drawerId')
    ...
    expect(mesParametres).toHaveAttribute('aria-controls', 'drawerId')
    ...
    expect(mesUtilisateurs).toHaveAttribute('aria-controls', 'drawerId')
