...
describe('membre', () => {
  it('quand j’accède à la page d’un membre, alors les informations du membre s’affichent', () => {
    // WHEN
    ...
    expect(termesIdentite).toHaveLength(7)
    ...
    expect(termesContact).toHaveLength(5)
    ...
    expect(termesRole).toHaveLength(3)
    ...
    expect(termesFinancements).toHaveLength(4)
    ...
    expect(menuItemsDocuments[1].textContent).toBe('Contrat de travail 220923 ExpiréePaul Durand, CDD, Expire le 23/09/2024')
  ...
  it('quand j’accède à la page d’un membre, alors le sommaire s’affiche', () => {
    // WHEN
    render(<Membre viewModel={membrePresenter('69')} />)
