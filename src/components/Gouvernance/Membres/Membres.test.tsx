...
describe('membres', () => {
  ...
  it.each([
    {
      ...
      expectedLength: 2,
      expectedRows: [
        ['Fédération départementale des centres sociaux du Rhône et de la Métropole de LyonAssociation', 'Fabien Beauvilliers', 'Observateur '],
  ...
  it(
    ...
    () => {
      ...
      fireEvent.change(labelFiltreTypologies, { target: { value: 'Rôles' } })
  ...
  it(
    ...
    () => {
      ...
      fireEvent.change(labelFiltreTypologies, { target: { value: 'Typologie' } })
