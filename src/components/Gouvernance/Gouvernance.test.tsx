...
describe('gouvernance', () => {
  ...
  it('quand j’affiche une gouvernance avec au moins une feuille de route, alors elle s’affiche avec son résumé et sa section feuille de route', () => {
    ...
    const gouvernanceViewModel = gouvernancePresenter(gouvernanceReadModelFactory({
      feuillesDeRoute: [
        {
          beneficiairesSubvention: [{ nom: 'Préfecture du Rhône', roles: ['coporteur'], type: 'Structure', uid: '0' }],
          beneficiairesSubventionFormation: [{ nom: 'Préfecture du Rhône', roles: ['coporteur'], type: 'Structure', uid: '1' }],
        ...
        {
          beneficiairesSubvention: [{ nom: 'Préfecture du Rhône', roles: ['coporteur'], type: 'Structure', uid: '2' }],
          beneficiairesSubventionFormation: [{ nom: 'Préfecture du Rhône', roles: ['coporteur'], type: 'Structure', uid: '3' }],
          budgetGlobal: 88_030,
          montantSubventionAccordee: 38_030,
          montantSubventionDemandee: 50_000,
          montantSubventionFormationAccordee: 5_000,
          nom: 'Feuille de route numérique du Rhône',
          porteur: { nom: 'Préfecture du Rhône', roles: ['coporteur'], type: 'Administration', uid: '1' },
          totalActions: 1,
      ...
      feuillesDeRoute: [
        {
          ...
          montantSubventionFormationAccordee: 5_000,
          nom: 'Feuille de route inclusion',
          porteur: { nom: 'Préfecture du Rhône', roles: ['coporteur'], type: 'Administration', uid: '2' },
          totalActions: 3,
