...
describe('membres', () => {
  ...
  it('en tant que gestionnaire departement et que je clique sur le membre de la préfecture, alors je vois les informations optionnelles remplacer par un tiret', () => {
    // GIVEN
