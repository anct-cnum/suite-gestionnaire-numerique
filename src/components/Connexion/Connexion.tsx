...
export default function Connexion({ idProvider }: Props): ReactElement {
  return (
    <div
      className={`fr-grid-row fr-grid-row-gutters fr-grid-row--center ${styles.center} ${styles['blue-background']}`}
    >
      <div className="fr-col-1" />
      <div className="fr-col-4">
        <France />
        <div className="fr-h2 color-blue-france">Mon inclusion numérique</div>
