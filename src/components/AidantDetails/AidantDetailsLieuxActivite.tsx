...
export default function AidantDetailsLieuxActivite(props: Props): ReactElement {
  ...
  return (
    <section className="fr-mb-4w grey-border border-radius fr-p-4w">
      ...
      <p className="fr-text--sm fr-text-mention--grey">Les lieux d&apos;activités du médiateur</p>
      ...
      {lieux.length === 0 ? (
        ...
        >
          <p className="fr-text--md fr-mb-0" style={{ textAlign: 'center' }}>
            <span className="fr-text--bold">👻 Aucun lieu d&apos;activité trouvé</span> pour {nom} {prenom}
          </p>
        </div>
      ) : (
        <>
              ...
              <div className="fr-grid-row fr-grid-row--middle fr-mb-2w">
                <div className="fr-col-12 fr-col-md-10">
                  ...
                  <div className="fr-text--sm fr-my-1w">
                    <span aria-hidden="true" className="fr-icon-map-pin-2-line fr-text--sm fr-text-mention--grey" />
