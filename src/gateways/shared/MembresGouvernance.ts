...
function membresUniquesRole(membre: MembreRecord): ReadonlyArray<MembreUniqueRole> {
  return [
...
function groupMembresById(membresById: MembresById, membreUniqueRole: MembreUniqueRole): MembresById {
...
type MembreUniqueRole = Readonly<{
  nom: string
  role: string
  type: string | null
  id: string
