...
describe.skip('gouvernance loader', () => {
  ...
  it('quand une gouvernance est demandée par son code département existant, alors elle est renvoyée', async () => {
    ...
    // WHEN
    const gouvernanceReadModel = await new PrismaGouvernanceLoader(etablirSyntheseFinanciereGouvernance).get('93')
  ...
  it('quand une gouvernance est demandée par son code département inexistant, alors une erreur est levée', async () => {
    ...
    // WHEN
    const gouvernanceReadModel = new PrismaGouvernanceLoader(etablirSyntheseFinanciereGouvernance).get(codeDepartementInexistant)
  ...
  it('quand une gouvernance est demandée par son code département existant avec un comité sans date de prochain comité, alors elle est renvoyée sans date de prochain comité', async () => {
    ...
    // WHEN
    const gouvernanceReadModel = await new PrismaGouvernanceLoader(etablirSyntheseFinanciereGouvernance).get(codeDepartement)
