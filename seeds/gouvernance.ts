...
function grouperDonneesACreer(
      ...
      return {
        ...
        ...gouvernanceFNE.membres.reduce(extraireMembresGouvernances(gouvernanceFNE, gouvernance), {
          ...
          membresDepartements: groupe.membresDepartements.concat({
            ...
            membreGouvernanceDepartementCode: gouvernance.departementCode,
  ...
  function ajouterMembresGouvernance(membreFNE: GouvernanceFNE['membres'][number], departementCode: string) {
    return (groupeMembres: GroupeMembres, role: string): GroupeMembres => {
      ...
      const roleEtMembreGouvernanceDepartementCode = { membreGouvernanceDepartementCode: departementCode, role }
      switch (true) {
        case Boolean(membreFNE.departementCode):
          [membreId, type] = [`departement-${membreFNE.departementCode}`, 'Conseil départemental']
          groupe = {
            ...groupe,
            membresDepartements: groupe.membresDepartements.concat({
              ...roleEtMembreGouvernanceDepartementCode,
        ...
        case Boolean(membreFNE.communeCode):
          [membreId, type] = [`commune-${membreFNE.communeCode}`, 'Collectivité, commune']
          groupe = {
            ...groupe,
        ...
        case Boolean(membreFNE.epciCode):
          [membreId, type] = [`epci-${membreFNE.epciCode}`, 'Collectivité, EPCI']
          groupe = {
            ...groupe,
        ...
        case Boolean(membreFNE.regionCode):
          [membreId, type] = [`sgar-${membreFNE.regionCode}`, 'Préfecture régionale']
          groupe = {
            ...groupe,
        ...
        case Boolean(membreFNE.siret):
          membreId = `structure-${membreFNE.siret}`
          groupe = {
            ...groupe,
