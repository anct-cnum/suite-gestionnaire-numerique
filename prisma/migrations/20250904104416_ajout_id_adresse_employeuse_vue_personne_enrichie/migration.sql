...
-- Recréer la vue avec l'ajout de id_adresse_employeuse
...
SELECT 
  *,
  ...
  -- ID de l'adresse de l'employeur (basé sur le type)
  CASE
    -- Pour un médiateur, prendre l'id de l'adresse de la structure dans personne_affectations
    ...
    -- Pour un aidant numérique, prendre l'id de l'adresse de la structure directe
