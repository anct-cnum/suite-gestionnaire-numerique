...
-- Name: DEFAULT PRIVILEGES FOR SEQUENCES; Type: DEFAULT ACL; Schema: min; Owner: sonum

ALTER DEFAULT PRIVILEGES FOR ROLE sonum IN SCHEMA min GRANT USAGE ON SEQUENCES TO app_python;
ALTER DEFAULT PRIVILEGES FOR ROLE sonum IN SCHEMA min GRANT ALL ON SEQUENCES TO min_scalingo;
ALTER DEFAULT PRIVILEGES FOR ROLE sonum IN SCHEMA min GRANT ALL ON SEQUENCES TO min_dev;


-- Name: DEFAULT PRIVILEGES FOR TABLES; Type: DEFAULT ACL; Schema: min; Owner: sonum

ALTER DEFAULT PRIVILEGES FOR ROLE sonum IN SCHEMA min GRANT SELECT ON TABLES TO app_python;
ALTER DEFAULT PRIVILEGES FOR ROLE sonum IN SCHEMA min GRANT ALL ON TABLES TO min_scalingo;
ALTER DEFAULT PRIVILEGES FOR ROLE sonum IN SCHEMA min GRANT ALL ON TABLES TO min_dev;
